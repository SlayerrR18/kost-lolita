...
<div class="dashboard-container">
    ...
    <div class="welcome-text">
        Selamat datang, <span class="fw-bold">{{ auth()->user()->name }}</span>! Ini adalah dashboard Anda. Di sini Anda dapat melihat informasi kost Anda.
    </div>

    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-title">Sisa Kontrak</div>
            <div class="stat-value">{{ $remainingContract}} Hari</div>
            <div class="stat-icon">
