...
@section('title', 'Tambah Pendapatan - Admin Kost Lolita')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <h1 class="text-2xl font-serif font-bold text-[#222831]">Catat Pendapatan Baru</h1>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="bg-[#222831] px-8 py-4 flex items-center justify-between">
                <h2 class="text-[#DFD0B8] font-bold text-lg flex items-center gap-2">
                    <i class="fa-solid fa-hand-holding-dollar"></i> Form Pemasukan
                </h2>
                <span class="text-xs text-gray-400 font-mono">{{ date('d M Y') }}</span>
            </div>

            <form action="{{ route('admin.finance.income.store') }}" method="POST" class="p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="source" id="source" value="{{ old('source') }}" placeholder="Contoh: Sewa Kamar 101 - Budi"
