        ...
        <form action="{{ route('admin.kost.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-field">
                            <input type="text" id="nomor_kamar" name="nomor_kamar" class="form-control @error('nomor_kamar') is-invalid @enderror" value="{{ old('nomor_kamar') }}" required>
            ...
            <div class="d-flex justify-content-end gap-3 mt-4">
                ...
                <button type="submit" class="btn-submit">
                    <i data-feather="save"></i> Simpan Kamar
                </button>
            </div>
        </form>
    </div>
