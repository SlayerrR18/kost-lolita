...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - Kost Lolita</title>
    ...
    <style>
        ...
        .nav-link.active{ background:rgba(26,127,90,.1); color:var(--primary); font-weight: 600; }
        ...
        .btn-logout { width: 100%; border: none; background: none; }
